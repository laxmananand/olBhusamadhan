                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:Panel ID="pnlDist" runat="server">
                            ...
                            <asp:Label ID="lblDetail" runat="server" Text="*Click on the Divion Name to view District-Wise Application Status"
                            ...
                            <asp:GridView ID="grd_Division" runat="server" AutoGenerateColumns="false" CssClass="table-responsive"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Division" HeaderStyle-Width="3%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                        ...
                        <asp:Panel ID="pnlDistrict" runat="server">
                            ...
                            <asp:Label ID="lblDetail2" runat="server" Text="*Click on the District Name to view SubDivision-Wise Application Status"
                                ForeColor="Green" Font-Size="X-Small"></asp:Label>
                            <asp:GridView ID="grdDistrict" runat="server" AutoGenerateColumns="false" CssClass="table-responsive"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="District" HeaderStyle-Width="4%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkDistrict" runat="server" CommandArgument='<%# Eval("DistCode")+","+Eval("DistName")%>'
                                                CommandName="DstClick" ForeColor="Blue" Font-Underline="false" ToolTip="Click here To View SubDivison-Wise Application Status"><%# Eval("DistName")%>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="True" ForeColor="White" Font-Names="Arial Unicode MS"
                        ...
                        <asp:Panel ID="pnlSubDivision" runat="server">
                            ...
                            <asp:GridView ID="grdSubDivision" runat="server" AutoGenerateColumns="false" CssClass="table-responsive"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sub-Division" HeaderStyle-Width="4%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkSubDivision" runat="server" CommandArgument='<%# Eval("Sd_Code2")+","+Eval("Sd_Name_En")%>'
                                                CommandName="sdClick" ForeColor="Blue" Font-Underline="false" ToolTip="Click here To View Circle/Block-Wise Application Status"><%# Eval("Sd_Name_En")%>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="True" ForeColor="White" Font-Names="Arial Unicode MS"
                            ...
                            <asp:GridView ID="grdThana" runat="server" AutoGenerateColumns="false" CssClass="table-responsive"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="PoliceStation" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkCircle" runat="server" CommandArgument='<%# Eval("PS_Code")%>'
                                                CommandName="CircleClick" ForeColor="Black" Font-Underline="false" ToolTip="Click here To View PanchayatWise Application Status"><%# Eval("Police_Station")%>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="True" ForeColor="White" Font-Names="Arial Unicode MS"
                                            Font-Size="Small" HorizontalAlign="Center" />
                        ...
                        <asp:Panel ID="pnlpanchayat" runat="server">
                            ...
                            <asp:GridView ID="grdPanchayat" runat="server" AutoGenerateColumns="false" CssClass="table-responsive"
                                HeaderStyle-BorderColor="White" EmptyDataText="No Record(s) found" EmptyDataRowStyle-ForeColor="Red"
                                ShowFooter="true" Width="100%" EmptyDataRowStyle-Font-Size="Large" ShowHeaderWhenEmpty="true"
                                OnRowCommand="grdPanchayat_RowCommand">
                                <Columns>
                                    <asp:TemplateField HeaderText="Sl. No." ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <%# Container.DataItemIndex+1 %>
                                    ...
                                    <asp:TemplateField HeaderText="Panchayat Name" HeaderStyle-Width="4%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkCircle" runat="server" CommandArgument='<%# Eval("PanchayatCode") + "," + Eval("BlockCode") +","+ Eval("PanchayatName") %>'
                                                CommandName="CircleClick" ForeColor="Blue" Font-Underline="false" ToolTip="Click here To View PanchayatWise Application Status"><%# Eval("PanchayatName")%>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="True" ForeColor="White" Font-Names="Arial Unicode MS"
