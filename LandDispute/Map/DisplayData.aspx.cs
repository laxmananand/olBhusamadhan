...
public partial class LandDispute_HQ_DisplayData : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
            LoadAllApplication(Village, FromDate,ToDate, AreaType);
    }
    ...
    /// </summary>  
    private void LoadAllApplication(string Village, string FromDate, string ToDate,string AreaType)
    {
        ...
        DataTable  dt = clsData.GetDataTableWithProc("getEntryPage_print", new SqlParameter[] { _fn2, _Village, _FromDate,_ToDate, _AreaType });
    ...
    {
        Response.Redirect("print.aspx?Village=" + ViewState["Village"] + "&AreaType="+ ViewState["AreaType"] + "&FromDate=" + ViewState["FromDate"] + "&ToDate=" + ViewState["ToDate"]);
    }
