<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Map.aspx.cs" Inherits="EOC_dmd_floodmapdata_Map" %>
       ...
       const drilldown = async function (e) {
           ...
           if (!e.seriesOptions) {
               ...
               if (e.point.ParameterType == "1") {
                   ...
                   chart.legend.title.attr({ text: 'भू - समाधान गृह विभाग, बिहार सरकार<br /> <span style="font-size: 9px; color: #666; font-weight: normal">' + datainfo + '</span>' });
                   ...
                   dataDrilldown.forEach((d, i) => {
                       d.drilldown = d.properties['panchayatcode'];
                       d.value = d.properties['panchayatcode'];
                       d.Per = d.properties['Per'];
                       d.ParameterType = "3";
                       d.BlockName = d.properties['PanchayatName'];
                       d.Samanya = d.properties['Samanya'];
                       d.Sumvadansheel = d.properties['Sumvadansheel'];
                       d.AtiSumvadansheel = d.properties['AtiSumvadansheel'];
                       d.Nirast = d.properties['Nirast'];
                       ...
                       $('#LandDistibuteDataTable').append('<tr style="background-color:' + d.properties['color'] + '">' +
                           ...
                           '<td> ' + d.properties['PanchayatName'] + ' </td>' +
                           '<td> ' + d.properties['Samanya'] + ' </td>' +
                           '<td> ' + d.properties['Sumvadansheel'] + ' </td>' +
                           '<td> ' + d.properties['AtiSumvadansheel'] + ' </td>' +
                           '<td> ' + d.properties['Nirast'] + ' </td>' +
