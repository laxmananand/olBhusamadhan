<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VadiAllConsolidateRpt.aspx.cs"
    Inherits="LandDispute_Reports_VadiDeatils_VadiAllConsolidateRpt" EnableEventValidation="false" %>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-dark" style="text-align: center; font-weight: bold;">Vadi wise Report</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:Panel ID="pnlgrid" runat="server" ScrollBars="Auto">
                            <asp:GridView ID="grvAllVadiConsolidate" runat="server" AutoGenerateColumns="false" CssClass="table-responsive"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="3%" HeaderText="General Vadi" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkGeneral_Vadi" runat="server" CommandArgument='<%# Eval("PS_Code")+","+ Eval("General_Vadi")%>' CommandName="General_VadiClick"
                                                Font-Underline="false" ForeColor="Blue" ToolTip="Click here To View Data"><%# Eval("General_Vadi")%>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="3%" HeaderText="Vibhag Vadi" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkVibhag_Vadi" runat="server" CommandArgument='<%# Eval("PS_Code")+","+ Eval("Vibhag_Vadi")%>' CommandName="Vibhag_VadiClick"
                                                Font-Underline="false" ForeColor="Blue" ToolTip="Click here To View Data"><%# Eval("Vibhag_Vadi")%>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="true" Font-Names="Arial Unicode MS" Font-Size="Small" ForeColor="White" />
                                        <ItemStyle Font-Size="Medium" HorizontalAlign="Left" ForeColor="Blue" />
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="3%" HeaderText="Institute" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkinstitute" runat="server" CommandArgument='<%# Eval("PS_Code")+","+ Eval("institute")%>' CommandName="instituteClick"
                                                Font-Underline="false" ForeColor="Blue" ToolTip="Click here To View Data"><%# Eval("institute")%>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="true" Font-Names="Arial Unicode MS" Font-Size="Small" ForeColor="White" />
                                        <ItemStyle Font-Size="Medium" HorizontalAlign="Left" ForeColor="Blue" />
