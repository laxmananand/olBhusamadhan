<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"  enableEventValidation ="false"
    CodeFile="VadiDistrictConsolidateRpt.aspx.cs" Inherits="LandDispute_Reports_VadiDeatils_VadiDistrictConsolidateRpt" %>
                   ...
                   <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-dark" style="text-align: center; font-weight: bold;">
                            Vadi Thana Wise Consolidated Report</h4>
                    </div>
                </div>
                   <div class="row">
                    <div class="col-md-3">
                                ...
                                <asp:Panel ID="pnlDistrict" runat="server">                          
                                    ...
                                    <asp:Panel ID="PanelDistrict" runat="server" ScrollBars="Auto">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="3%" HeaderText="General Vadi" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
