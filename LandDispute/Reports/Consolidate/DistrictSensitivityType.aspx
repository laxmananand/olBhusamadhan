<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" enableEventValidation ="false"
    CodeFile="DistrictSensitivityType.aspx.cs" Inherits="LandDispute_Reports_Crime_IncidentDistrictConsolidateRpt" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-dark" style="text-align: center; font-weight: bold;">
                            District Wise Sensitivity Report</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="EntryMode" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Wrap="false"
                                ItemStyle-Width="5%">
                                <ItemTemplate>
                                    <%#Eval("EntryMode")%>
                                </ItemTemplate>
