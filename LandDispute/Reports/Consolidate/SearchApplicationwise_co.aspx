<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SearchApplicationwise_co.aspx.cs" Inherits="LandDispute_Reports_Consolidate_SearchApplicationwise_co" %>
             ...
             <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                 <ContentTemplate>
                     ...
                     <div class="row" style="padding-top: 0.5px;">
                         ...
                         <div class="col-md-2 text-center">
                             <asp:Label ID="Label9" runat="server" Text="Entry Mode"></asp:Label>
                         </div>
