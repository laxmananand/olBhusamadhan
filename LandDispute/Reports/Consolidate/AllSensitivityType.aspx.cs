...
public partial class LandDispute_Reports_Consolidate_AllSensitivityType : System.Web.UI.Page
{
    ...
    protected void bindCommissionary()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity", new SqlParameter[] { QueryType });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindDistrict()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity", new SqlParameter[] { QueryType, _CommissionaryCode , Rangeid });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindSubDivision()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity", new SqlParameter[] { QueryType, _DistCode });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindCircle()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity", new SqlParameter[] { QueryType, _SubDivision });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindThana()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity", new SqlParameter[] { QueryType, _Blockcode });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindAllVadiConsolidate_Grid()
    {
        ...
        SqlParameter _Sensitivity_Type = new SqlParameter("@Sensitivity_Type", ddlSensitivityType.SelectedValue == "0" ? "0" : ddlSensitivityType.SelectedValue);
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity", new SqlParameter[] { QueryType, _CommissionaryCode, _DistCode, _SubDivision, _Blockcode
            ,_pscode,_Sensitivity_Type, _fromdate, _ToDate,GetEntry_Mode ,Rangeid});
        if (dt.Rows.Count > 0)
        {
            ...
            grvAllVadiConsolidate.Columns[7].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("Sensitivity1")).Sum().ToString();
            grvAllVadiConsolidate.Columns[8].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("Sensitivity2")).Sum().ToString();
            grvAllVadiConsolidate.Columns[9].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("Sensitivity3")).Sum().ToString();
    ...
    private void getPanchayatWiseData(string Discode, string subcode, string BlockCode, string ThanaCode, string type)   
    {
        try
        {
            ...
            SqlParameter getThanaCode = new SqlParameter("@ThanaCode", Convert.ToInt32(ThanaCode.Trim()));
            SqlParameter gettype = new SqlParameter("@Sensitivity_Type", Convert.ToInt32(type.Trim()));
            SqlParameter GetEntry_Mode = new SqlParameter("@EntryMode", ddlentrymode.SelectedValue.Trim());

            DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity", new SqlParameter[] 
            { GetQueryType, getDiscode, getsubcode,getBlockCode,getThanaCode,gettype,GetEntry_Mode});
            if (dt.Rows.Count > 0)
            {
    ...
    protected void grvAllVadiConsolidate_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "TotalClick")
        {
            ...
            {
                getPanchayatWiseData(Discode, subcode, BlockCode, ThanaCode, type);
        ...
        else if (e.CommandName == "Sensitivity2_Click")
        {
            string Discode = e.CommandArgument.ToString().Trim().Split(',')[0];
            string subcode = e.CommandArgument.ToString().Trim().Split(',')[1];
            string BlockCode = e.CommandArgument.ToString().Trim().Split(',')[2];
        ...
        else if (e.CommandName == "Sensitivity3_Click")
        {
            string Discode = e.CommandArgument.ToString().Trim().Split(',')[0];
            string subcode = e.CommandArgument.ToString().Trim().Split(',')[1];
            string BlockCode = e.CommandArgument.ToString().Trim().Split(',')[2];
