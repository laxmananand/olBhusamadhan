...
public partial class LandDispute_Reports_Consolidate_SearchApplicationwise_co : System.Web.UI.Page
{
    ...
    private void bindCommissionary()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("SearchApplicationWise_co", new SqlParameter[] { QueryType });
        if (dt.Rows.Count > 0)
        {
    ...
    private void bindDistrict()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("[SearchApplicationWise_new_co]", new SqlParameter[] { QueryType, CommissionaryCode, Rangeid });
        if (dt.Rows.Count > 0)
        {
    ...
    private void bindSubDivision()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("SearchApplicationWise_co", new SqlParameter[] { QueryType, District });
        if (dt.Rows.Count > 0)
        {
    ...
    private void bindBlock()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("SearchApplicationWise_co", new SqlParameter[] { QueryType, @SubDivision });
        if (dt.Rows.Count > 0)
        {
    ...
    private void bindthana()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("SearchApplicationWise_co", new SqlParameter[] { QueryType, District, @SubDivision, block });
        if (dt.Rows.Count > 0)
        {
    ...
    void bindDivision()
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("SearchApplicationWise_new_co", new SqlParameter[] { QueryType, GetComm_Code,GetRange_Code, GetDistrict_Code, GetSub_DivCode, GetBlock_Code,
                GetThana_Code,GetApplicationNo,Getvadi_Name,GetEntry_Mode,GetpratiVadi_Name,GetVadi_MobileNo,GetpratiVadi_MobileNo,
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strFilePath = "Information_public.aspx?RegId=" + UrlRedirect;
