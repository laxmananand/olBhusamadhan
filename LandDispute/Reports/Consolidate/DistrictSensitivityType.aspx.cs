...
public partial class LandDispute_Reports_Crime_IncidentDistrictConsolidateRpt : System.Web.UI.Page
{
    ...
    protected void getDistrictWiseRpt(string DIVISIONCODE)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity_District", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode,  GetBlockCode, GetThanCode, GetPanchayatCode , Rangeid });
    ...
    protected void getCircleWiseRpt(string Distcode)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity_District", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode, GetSubdivision, GetBlockCode, GetThanCode, GetPanchayatCode });
    ...
    protected void getThanaWiseRpt(string Blockcode)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity_District", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode, GetBlockCode, GetThanCode, GetPanchayatCode });
    ...
    private void getPanchayatWiseData(string Code, string type, string sensitivityType)
    {
        try
        {
            ...
            SqlParameter Block_Code = new SqlParameter("@BlockCode", Session["Block_Code"]);
            SqlParameter Thana_code = new SqlParameter("@ThanCode", ViewState["ThanaCode"]);
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_AllSensitivity_District", new SqlParameter[] { GetQueryType, Getcode, Block_Code, Thana_code, Gettype, GetsensitivityType });
            if (dt.Rows.Count > 0)
            {
