...
public partial class LandDispute_Reports_PratiVadi_Report_PratiVadiDistrictConsolidateRpt : System.Web.UI.Page
{
    ...
    protected void getVibhag_Vadi(int Code)
    {
        ...
        if (pnlDistrict.Visible == true && pnlDistrict.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDistrictRpt", new SqlParameter[] { GetQuery, GetDistrictCode });
        }       
        if (pnlCircle.Visible == true && grdCircle.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDistrictRpt", new SqlParameter[] { GetQuery, GetBlockCode });
        }
        if (pnlthana.Visible == true && grdThana.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDistrictRpt", new SqlParameter[] { GetQuery, GetThanaCode });
        }
        if (pnlpanchayat.Visible == true && grdPanchayat.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDistrictRpt", new SqlParameter[] { GetQuery, GetPanchayatCode });
        }
        if (dt.Rows.Count > 0)
        {
    ...
    protected void getDistrictWiseRpt(string DIVISIONCODE)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_PrtiVadiDistrictRpt", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode, GetBlockCode, GetThanCode, GetPanchayatCode, Rangeid });
    ...
    protected void getCircleWiseRpt(string DistrictCode)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_PrtiVadiDistrictRpt", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode,GetBlockCode, GetThanCode, GetPanchayatCode });
    ...
    private void getPanchayatWiseData(string ThanaCode, string PanchayatCode)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_PrtiVadiDistrictRpt", new SqlParameter[] { GetQueryType, GetThana_Code, GetPanchayatCode });
            if (dt.Rows.Count > 0)
            {
                btn_Export.Visible = true;
