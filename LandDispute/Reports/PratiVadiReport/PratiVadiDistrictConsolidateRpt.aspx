<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"  enableEventValidation ="false"
    CodeFile="PratiVadiDistrictConsolidateRpt.aspx.cs" Inherits="LandDispute_Reports_PratiVadi_Report_PratiVadiDistrictConsolidateRpt" %>
                   ...
                   <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-dark" style="text-align: center; font-weight: bold;">
                            Prativadi Thana Wise Consolidated Report</h4>
                    </div>
                </div>
                   <div class="row">
                    <div class="col-md-3">
