...
public partial class LandDispute_Reports_PratiVadi_Report_PratiVadiAllConsolidateRpt : System.Web.UI.Page
{
    ...
    private void bindRange()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_PrativadiAllConsolidateReport", new SqlParameter[] { QueryType });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindDistrict()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_PrativadiAllConsolidateReport", new SqlParameter[] { QueryType, _CommissionaryCode, Rangeid });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindSubDivision()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_PrativadiAllConsolidateReport", new SqlParameter[] { QueryType, _DistCode });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindCircle()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_PrativadiAllConsolidateReport", new SqlParameter[] { QueryType, _SubDivision });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindThana()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_PrativadiAllConsolidateReport", new SqlParameter[] { QueryType, _Blockcode });
        if (dt.Rows.Count > 0)
        {
    ...
    protected void bindAllVadiConsolidate_Grid()
    {
        ...
        DataTable dt = clsData.GetDataTableWithProc("sp_PrativadiAllConsolidateReport", new SqlParameter[] { QueryType, _CommissionaryCode, GetRange_Code, _DistCode, _SubDivision, _Blockcode, _pscode, _fromdate, _ToDate, GetEntry_Mode });
        if (dt.Rows.Count > 0)
        {
    ...
    private void getPanchayatWiseData(string thanacode,string gettype)   
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_PrativadiAllConsolidateReport", new SqlParameter[] { GetQueryType, GetThana_code, GetBlock_code, GetType, GetEntry_Mode });
            if (dt.Rows.Count > 0)
            {
