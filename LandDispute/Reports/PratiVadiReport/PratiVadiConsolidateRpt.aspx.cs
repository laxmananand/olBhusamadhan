...
public partial class LandDispute_Reports_PratiVadi_Report_PratiVadiConsolidateRpt : System.Web.UI.Page
{
    ...
    void bindDivision()
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode, GetSubDivisionCode, GetBlockCode, GetThanCode, GetPanchayatCode});
    ...
    protected void getVibhag_Vadi(int Code)
    {
        ...
        if (pnlDist.Visible == true && grd_Division.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQuery, GetDivisionCode });
        }
        if (pnlDistrict.Visible == true && pnlDistrict.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQuery, GetDistrictCode });
        }
        if (pnlSubDivision.Visible == true && grdSubDivision.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQuery, GetSubDivisionCode });
        }
        if (pnlCircle.Visible == true && grdCircle.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQuery, GetBlockCode });
        }
        if (pnlthana.Visible == true && grdThana.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQuery, GetThanaCode });
        }
        if (pnlpanchayat.Visible == true && grdPanchayat.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQuery, GetPanchayatCode });
        }
        if (dt.Rows.Count > 0)
        {
    ...
    protected void getDistrictWiseRpt(string DIVISIONCODE)
    {
        ...
        {        
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQuery, GetDivisionCode, Rangeid, GetDistrictCode, GetSubDivisionCode, GetBlockCode, GetThanCode, GetPanchayatCode});
    ...
    private void getPanchayatWiseData(string ThanaCode, string PanchayatCode)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("sp_PrtiVadiDivisionRpt", new SqlParameter[] { GetQueryType, GetThana_Code, GetPanchayatCode });
            if (dt.Rows.Count > 0)
            {
                btn_Export.Visible = true;
