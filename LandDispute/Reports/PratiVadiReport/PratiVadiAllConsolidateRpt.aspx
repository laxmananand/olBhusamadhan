<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PratiVadiAllConsolidateRpt.aspx.cs"
    Inherits="LandDispute_Reports_PratiVadi_Report_PratiVadiAllConsolidateRpt" EnableEventValidation="false" %>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-dark" style="text-align: center; font-weight: bold;">Prativadi wise Report</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:Panel ID="pnlgrid" runat="server" ScrollBars="Auto">
                            <asp:GridView ID="grvAllVadiConsolidate" runat="server" AutoGenerateColumns="false" CssClass="table-responsive"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="3%" HeaderText="General Prativadi" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
