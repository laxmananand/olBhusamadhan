...
public partial class LandDispute_Reports_Court_CourtDistrictConsolidateRpt : System.Web.UI.Page
{
    ...
    protected void getRaajasv_nyaayaalay(int Code)
    {
        ...
        if (pnlDistrict.Visible == true && pnlDistrict.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQuery, GetDistrictCode });
        }
        if (pnlCircle.Visible == true && grdCircle.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQuery, GetBlockCode });
        }
        if (pnlthana.Visible == true && grdThana.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQuery, GetThanaCode });
        }
        if (pnlpanchayat.Visible == true && grdPanchayat.Visible == true)
        {
            ...
            dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQuery, GetPanchayatCode });
        }
        if (dt.Rows.Count > 0)
        {
    ...
    protected void getDistrictWiseRpt(string DIVISIONCODE)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode, GetBlockCode, GetThanCode, GetPanchayatCode, Rangeid });
    ...
    protected void getCircleWiseRpt(string Distcode)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode, GetBlockCode, GetThanCode, GetPanchayatCode });
    ...
    private void getPanchayatWiseData(string Thanacode, string Panchayatcode)
    {
        try
        {
            ...
            SqlParameter GetQueryType = new SqlParameter("@QueryType", "14");
            ...
            DataTable dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQueryType, GetThana_code, GetPanchayat_Code});
            if (dt.Rows.Count > 0)
            {
                btn_Export.Visible = true;
    ...
    protected void btnback_Click(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["GetNayalaya"].ToString() == "Raajasv_nyaayaalay_District" && Panelraajasv_nyaayaalay.Visible == true && grdraajasv_nyaayaalay.Visible == true)
            {
                ViewState["GetNayalaya"] = "";
                if ((ViewState["RoleStepBack"].ToString() == "5") || (ViewState["RoleStepBack"].ToString() == "4"))
                {
    ...
    protected void lnkTotalRajashvnayala_Click(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt32(Total) > 0)
        {
            ...
            if (ViewState["GetNayalaya"].ToString() == "Raajasv_nyaayaalay_District")
            {
                ...
                dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQuery, _Type, _Code, _courtID, _courtTypeID });
            }           
    ...
    protected void lnkTotalVahavarnayala_Click(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt32(Total) > 0)
        {
            DataTable dt = new DataTable();
            SqlParameter GetQuery = new SqlParameter("@QueryType", "15");
            if (ViewState["GetNayalaya"].ToString() == "Vyavahaara_nyaayaalay_District")
            {
    ...
    protected void lnkDistrictLokShikayat_Nivaran_nyaayaalay_Click(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt32(Total) > 0)
        {
            ...
            dt = clsData.GetDataTableWithProc("Sp_GetDistrictCourtConsolidateReport", new SqlParameter[] { GetQuery, _Type, _Code, _courtID });
            if (dt.Rows.Count > 0)
            {
                GridView1.DataSource = dt;
                GridView1.DataBind();
