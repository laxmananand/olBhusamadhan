<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="DisputeConsolidateBlockRpt.aspx.cs" 
...
.mGrid .pgr a:hover { color: #000; text-decoration: none; }
    ...
    <script type="text/javascript">
        ...
        function getpdfdocument(urlpdf) {
            ...
            $.ajax({
                type: "POST",
                url: "DisputeConsolidateBlockRpt.aspx/Getpdf",
                data: "{'url':'" + urlpdf + "'}",
        ...
        <div class="card">
                                             ...
                                             <div class="card-body">
                                                      <asp:UpdatePanel runat="server" ID="pnlupdate1" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <div class="row mb-2">
                                                                    <div class="col-md-2" runat="server" id="divddlRange">
                                                                        <asp:Label ID="Label10" runat="server" Text="Range"></asp:Label>
                                                                        <asp:DropDownList ID="ddlRange" runat="server" CssClass="form-control mb-2" Enabled="true">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                    <div class="col-md-2" runat="server" id="divddlCommissionary">
