...
public partial class LandDispute_Reports_Disputs_Details_DisputeConsolidateBlockRpt : System.Web.UI.Page
{
    ...
    private void bindDivision()
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("stp_GetBlockDisputeConsolidateRpt", new SqlParameter[] { _QueryType,GetComm_Code, GetDistrict_Code, GetSub_DivCode, GetBlock_Code, GetThana_Code, GetBhumiVivadType, getfromdate, gettodate, GetEntry_Mode, Getmatter_status, GetRange_Code });
            if (dt.Rows.Count > 0)
            {
