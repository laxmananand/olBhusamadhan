<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="All_IncidentConsolidateReport.aspx.cs"
    Inherits="LandDispute_Reports_Crime_All_IncidentConsolidateReport" %>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-dark" style="text-align: center; font-weight: bold;">Incident wise Report</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row" style="padding: 5px">
                    <div class="col-md-1 text-center"></div>
                    <div class="col-md-2 text-center" id="btnBack_div" runat="server">
                        <br />
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:Panel ID="pnlgrid" runat="server" ScrollBars="Auto">
                            <asp:GridView ID="grvAllIncident" runat="server" AutoGenerateColumns="false" CssClass="table-responsive"
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="3%" HeaderText="Praathamikee" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkpraathamikee" runat="server"
                                                CommandArgument='<%# Eval("DISTRICTCODE")+","+Eval("Sd_Code2")+","+Eval("BlockCode")+","+Eval("PS_Code")%>'
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="3%" HeaderText="Snaha" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnksnaha" runat="server"
                                                CommandArgument='<%# Eval("DISTRICTCODE")+","+Eval("Sd_Code2")+","+Eval("BlockCode")+","+Eval("PS_Code")%>'
                                                Text='<%# Eval("snaha")%>' OnClick="lnksnaha_Click"
                                                Font-Underline="false" ForeColor="Blue" ToolTip="Click here To View Raajasv_nyaayaalay-Wise">
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="true" Font-Names="Arial Unicode MS" Font-Size="Small" ForeColor="White" />
