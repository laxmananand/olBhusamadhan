<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" enableEventValidation ="false"
    CodeFile="IncidentDistrictConsolidateRpt.aspx.cs" Inherits="LandDispute_Reports_Crime_IncidentDistrictConsolidateRpt" %>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="text-dark" style="text-align: center; font-weight: bold;">
                            District Incident Consolidated Report</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                         <asp:Panel ID="pnlDistrict" runat="server" Visible="false">                           
                            ...
                            <asp:Label ID="lblDetailForDistrict" runat="server" Text="*Click on the District Name to view SubDivision-Wise Application Status"
                               ...
                               <asp:Panel ID="panel2" runat="server" ScrollBars="Auto">
                                                ...
                                                ShowHeaderWhenEmpty="True" CellPadding="4" ForeColor="#333333" GridLines="Both">
                                                ...
                                                <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Total Incident" HeaderStyle-Width="3%" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblTotalIncident" runat="server" Text='<%# Eval("TotalIncident")%>'></asp:Label>                            
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left"/>
                                                        ...
                                                        <asp:TemplateField HeaderText="Praathamikee" HeaderStyle-Width="3%" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Apraathamikee" HeaderStyle-Width="3%" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblTotalApraathamikee" runat="server" Text='<%# Eval("apraathamikee")%>' ></asp:Label>                            
                                                            </ItemTemplate>
                                                            <ItemStyle HorizontalAlign="Left"/>
                                                            <HeaderStyle BackColor="#1C6794" Font-Bold="True" ForeColor="White" Font-Names="Arial Unicode MS"
                                                                Font-Size="Small" HorizontalAlign="Left" />
                             ...
                             <asp:Panel ID="panel4" runat="server" ScrollBars="Auto">
                                ...
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                 <Columns>
                                      ...
                                      <asp:TemplateField HeaderStyle-Width="4%" HeaderText="Circle" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                            ...
                            <asp:Label ID="lblDetailForThana" runat="server" Text="*Click on the PoliceStation Name to view Panchayat-Wise Application Status"
                             ...
                             <asp:Panel ID="panel5" runat="server" ScrollBars="Auto">
                                ...
                                <Columns>
                                         ...
                                         <asp:TemplateField HeaderStyle-Width="4%" HeaderText="Thana" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="Total Incident" HeaderStyle-Width="3%" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                              <%--  <asp:LinkButton ID="lnkpraathamikee1" runat="server"
                                                    CommandArgument='<%# Eval("PS_Code")%>'
                                                    Text='<%# Eval("TotalIncident")%>' OnClick="lnkTotalincident_Click"
                                                    Font-Underline="false" ForeColor="Blue" ToolTip="Click here To View Total Incident">
                                                </asp:LinkButton>--%>
                                 ...
                                 <%--   change start--%>
                                       ...
                                       <asp:TemplateField HeaderStyle-Width="3%" HeaderText="Praathamikee" ItemStyle-HorizontalAlign="Left">
                                           <ItemTemplate>
                                               <asp:LinkButton ID="lnkpraathamikee" runat="server"
                                                   CommandArgument='<%# Eval("PS_Code")%>'
                                                   Text='<%# Eval("praathamikee")%>' OnClick="lnkpraathamikee_Click"
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="3%" HeaderText="Snaha" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnksnaha" runat="server"
                                                CommandArgument='<%#Eval("PS_Code")%>'
                                                Text='<%# Eval("sanaha")%>' OnClick="lnksnaha_Click"
                                                Font-Underline="false" ForeColor="Blue" ToolTip="Click here To View Raajasv_nyaayaalay-Wise">
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="true" Font-Names="Arial Unicode MS" Font-Size="Small" ForeColor="White" />
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="3%" HeaderText="Apraathamikee" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkapraathamikee" runat="server"
                                                CommandArgument='<%#Eval("PS_Code")%>'
                                                Text='<%# Eval("apraathamikee")%>' OnClick="lnkapraathamikee_Click"
                                                Font-Underline="false" ForeColor="Blue" ToolTip="Click here To View Raajasv_nyaayaalay-Wise">
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#1C6794" Font-Bold="true" Font-Names="Arial Unicode MS" Font-Size="Small" ForeColor="White" />
                        ...
                        <asp:Panel ID="Panel1" runat="server" Style="overflow-x: auto; overflow-y: hidden;" Visible="false">
    <asp:GridView ID="GridView2" OnRowDataBound="GridView1_RowDataBound" runat="server" DataKeyNames="a_id"
