...
public partial class LandDispute_Report_IncidentConsolidateRpt : System.Web.UI.Page
{
    ...
    void bindDivision()
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("Sp_GetCrimeIncidentConsolidateRpt", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode, GetSubDivisionCode, GetBlockCode, GetThanCode, GetPanchayatCode, GetVillageCode, GetWardCode });
            lblPrintDateForDivision.Text = DateTime.Now.ToString();
            if (dt.Rows.Count > 0)
            {                             
                grd_Division.Columns[1].FooterText = "Total :";
                grd_Division.Columns[2].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("TotalIncident")).Sum().ToString();
                grd_Division.Columns[3].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("praathamikee")).Sum().ToString();
                grd_Division.Columns[4].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("apraathamikee")).Sum().ToString();
                grd_Division.Columns[5].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("sanaha")).Sum().ToString();
    ...
    protected void getDistrictWiseRpt(string DIVISIONCODE)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("Sp_GetCrimeIncidentConsolidateRpt", new SqlParameter[] { GetQuery, GetDivisionCode, GetDistrictCode, GetSubDivisionCode, GetBlockCode, GetThanCode, GetPanchayatCode, GetVillageCode, GetWardCode, Rangeid });
    ...
    protected void getSubDivisionWiseRpt(string DistCode)
    {
        ...
        {            
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                grdSubDivision.Columns[2].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("TotalIncident")).Sum().ToString();
                grdSubDivision.Columns[3].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("praathamikee")).Sum().ToString();
                grdSubDivision.Columns[4].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("apraathamikee")).Sum().ToString();
                grdSubDivision.Columns[5].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("sanaha")).Sum().ToString();
    ...
    protected void getThanaWiseRpt(string Blockcode)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                grdThana.Columns[4].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("apraathamikee")).Sum().ToString();
                grdThana.Columns[5].FooterText = dt.AsEnumerable().Select(x => x.Field<int>("sanaha")).Sum().ToString();
    ...
    private void getPanchayatWiseData(string thanacode, string Panchayatcode)
    {
        try
        {
            ...
            DataTable dt = clsData.GetDataTableWithProc("Sp_GetCrimeIncidentConsolidateRpt", new SqlParameter[] { GetQueryType, GetThana_code, GetPanchayat_Code});
            if (dt.Rows.Count > 0)
            {
